...
public class WebServer {
  ...
  private Container currentActivity;
  private final Container root;

  public WebServer(Container root) {
    this.root = root;
  ...
  private Container findActivityById(int id) {
    return ((core.Project)root).findContainerById(id);
  }
    ...
    private String makeBodyAnswer(String[] tokens) {
      ...
      switch (tokens[0]) {
        case "get_tree" : {
          ...
          Container activity = findActivityById(id);
